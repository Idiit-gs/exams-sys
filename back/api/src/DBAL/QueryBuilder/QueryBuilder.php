...
class QueryBuilder implements BuildableInterface
{
	...
	*/
	...
	/**
	 * bindParam method. Accepts the parameters of a prepared sql statement.
	 * parameter data types could be an array or a single. PHP does not
	 * method overloading
	 * out of the box, so this is our own way of creating a function|method that
	 * behaves differently under different scenarios.
	 *
	 * @param string|array $params Parameters of the preparedstatement.
	...
	public function bindParam($query_string, ...$params)
	{
		...
		return array($query_string, $params);
	}
